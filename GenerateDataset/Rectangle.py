...
def GenerateRectangleDataset(purpose, numData):
    ...
    for i in range(numData):
        ...
        imgPath = os.path.join(DEST_IMG_FOLDER, f'Rectangle_{i}.png')
        cv2.imwrite(imgPath, image)

        labelPath = os.path.join(DEST_LABEL_FOLDER, f'Rectangle_{i}.txt')
        with open(labelPath, 'w') as f:
            ...
            f.write(f"{x1 / 128.0} {y1 / 128.0} {x2 / 128.0} {y1 / 128.0} ")
            f.write(f"{x2 / 128.0} {y1 / 128.0} {x2 / 128.0} {y2 / 128.0} ")
            f.write(f"{x2 / 128.0} {y2 / 128.0} {x1 / 128.0} {y2 / 128.0} ")
            f.write(f"{x1 / 128.0} {y2 / 128.0} {x1 / 128.0} {y1 / 128.0} ")
            f.write("\n")
